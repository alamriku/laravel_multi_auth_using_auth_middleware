    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div id="responsive-modal" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form id="submit-form" action="{{route('submit-image')}}" method="post" enctype="multipart/form-data">
                                        @csrf
                                    <div class="modal-body">
                                        <div class="progress m-t-20">
                                            <div class="progress-bar bg-success" style="width: 0%; height:15px;" role="progressbar" aria-valuenow=""
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="input-file-now">Image Upload</label>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <button data-toggle="modal" data-target="#responsive-modal" class="btn btn-danger waves-effect waves-light mb-2">Upload Image</button>
                            </div>
                            <div class="col-sm-6">
                                <form action="">
                                    <div class="form-group row">
                                        <label for="recipient-name" class="col-2 col-form-label">Search</label>
                                        <div class="col-10">
                                            <input type="text" class="form-control search" name="image_title" id="image-title">
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="row justify-content-center">
            <div  id="data" class="col-md-12">
                @if(($images ) == null)
                <div class="card prev_card" style="width: 20rem;">
                    <img class="card-img-top preview" src="{{asset('public/uploads/Portrait_Placeholder.png')}}" alt="Card image cap" width="150" height="150">
                    <div class="card-body">
                        <h4 class="card-title">Empty Data</h4>
                    </div>
                </div>
                    @else
                    ...
                    @foreach($images as $key=>$r)
                        ...
                        <div class="card" id="{{$key}}" style="width: 20rem;">
                            <img class="card-img-top preview" src="{{$r[1]}}" alt="Card image cap" width="150" height="150">
                            <div class="card-body">
                                <div  id="marquee{{$key}}" class="height" style="height: 36px;">
                                    <p id="str{{$key}}"  style="white-space: nowrap;">{{$r[0]}}</p>
                                </div>

                                <input type="hidden" name="json_index" value="{{$key}}"/>
                                <button  class="btn btn-danger btn_del mt-1"><svg  width="30px" height="30px" version="1.1"  x="0px" y="0px"
